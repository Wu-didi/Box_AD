...
"""
Box_AD 完整自动驾驶栈 Launch 文件

启动命令:
  ros2 launch Box_AD box_ad.launch.py

带参数启动:
  ros2 launch Box_AD box_ad.launch.py map_path:=/path/to/map.png max_speed:=3.0

只启动部分模块:
  ros2 launch Box_AD box_ad.launch.py use_imu:=false use_perception:=false
"""
...
def generate_launch_description():
    ...
    startup_log = LogInfo(msg='Box_AD 自动驾驶栈启动中...')
